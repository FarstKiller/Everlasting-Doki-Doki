...
transform right_menu_anim_fast(xal):
    xoffset -100
    alpha 0.0
    easein 1.5 xoffset xal alpha 1.0
    on idle:
        zoom 1.0
    on selected_idle:
        easein 0.5 zoom 1.1
    ...
    on hide:
        xoffset xal
        alpha 1.0
        easein 1.0 xoffset -100 alpha 0.0

transform bg_zoom_l(z=1.0, zz=1.0, t=0.25, x=0.5, xx=0.5, y=0.5, yy=0.5):
    zoom z xalign x yalign y
    linear t zoom zz xalign xx yalign yy
    
transform bg_zoom_e(z=1.0, zz=1.0, t=0.25, x=0.5, xx=0.5, y=0.5, yy=0.5, a=1.0):
    zoom z xalign x yalign y alpha a
    ease t zoom zz xalign xx yalign yy

transform xypos(xp=0.5, yp=1.0, time=0.0):
    ease time xpos xp ypos yp

transform up_poem_anim(yal):
    yoffset -300
    alpha 0.0
...
transform room_mask_zoom3:
    size (320,180)
    pos (30,200)

transform screen_normal:
    linear 2.0 xalign 0.5 yalign 0.5

transform room_mask_zoom4:
    size (320,180)
    pos (935,200)

transform super_shake:
    block:
        parallel:
            parallel:
                choice:
...
transform shake(t1=null_transform, t2=null_transform, t3=null_transform, t4=null_transform, t5=null_transform, t6=null_transform):
    parallel:
        t1
    parallel:
        t2
